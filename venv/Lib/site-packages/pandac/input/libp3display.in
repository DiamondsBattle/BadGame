...
661 19 ~DisplayInformation 0 4 1329 39 DisplayInformation::~DisplayInformation 0 0 10
/**
 *
 */
46
...
662 18 DisplayInformation 0 4 1329 38 DisplayInformation::DisplayInformation 0 2 13 14 10
/**
 *
 */
130
...
717 15 ~DrawableRegion 0 6 1333 31 DrawableRegion::~DrawableRegion 0 0 10
/**
 *
 */
46
...
741 12 WindowHandle 0 4 1340 26 WindowHandle::WindowHandle 0 2 89 90 22
/**
 *
 */
...
747 8 OSHandle 0 4 1342 32 WindowHandle::OSHandle::OSHandle 0 1 97 197
/**
...
752 16 WindowProperties 0 4 1343 34 WindowProperties::WindowProperties 0 1 101 22
/**
 *
 */
...
754 17 ~WindowProperties 0 4 1343 35 WindowProperties::~WindowProperties 0 0 10
/**
 *
 */
49
...
838 14 ~DisplayRegion 0 6 1351 29 DisplayRegion::~DisplayRegion 0 0 10
/**
 *
 */
44
...
854 15 ~GraphicsOutput 0 6 1354 31 GraphicsOutput::~GraphicsOutput 0 0 10
/**
 *
 */
46
...
962 14 GraphicsEngine 0 4 1376 30 GraphicsEngine::GraphicsEngine 0 1 424 187
/**
...
965 22 GraphicsThreadingModel 0 4 1378 46 GraphicsThreadingModel::GraphicsThreadingModel 0 2 453 454 1249
/**
 *
 */
...
979 23 ~GraphicsThreadingModel 0 4 1378 47 GraphicsThreadingModel::~GraphicsThreadingModel 0 0 0
54
...
1065 19 make_texture_buffer 0 4 1354 35 GraphicsOutput::make_texture_buffer 0 1 314 1209
/**
...
1166 21 FrameBufferProperties 0 4 1394 44 FrameBufferProperties::FrameBufferProperties 0 2 471 472 0
165
...
1186 22 ~FrameBufferProperties 0 4 1394 45 FrameBufferProperties::~FrameBufferProperties 0 0 0
52
...
1202 26 ~GraphicsWindowInputDevice 0 4 1395 53 GraphicsWindowInputDevice::~GraphicsWindowInputDevice 0 0 0
60
...
1207 9 TouchInfo 0 4 1397 20 TouchInfo::TouchInfo 0 1 552 0
57
inline TouchInfo::TouchInfo(TouchInfo const &) = default;

1208 10 ~TouchInfo 0 4 1397 21 TouchInfo::~TouchInfo 0 0 0
28
...
1217 31 ~GraphicsWindowProcCallbackData 0 4 1399 63 GraphicsWindowProcCallbackData::~GraphicsWindowProcCallbackData 0 0 0
70
...
1246 19 ~WindowCallbackData 0 4 1403 63 CallbackGraphicsWindow::WindowCallbackData::~WindowCallbackData 0 0 0
70
...
1248 19 ~EventsCallbackData 0 4 1405 63 CallbackGraphicsWindow::EventsCallbackData::~EventsCallbackData 0 0 0
70
...
1256 19 ~RenderCallbackData 0 4 1408 63 CallbackGraphicsWindow::RenderCallbackData::~RenderCallbackData 0 0 0
70
...
1281 11 DisplayMode 0 4 1409 24 DisplayMode::DisplayMode 0 2 612 613 0
112
inline DisplayMode::DisplayMode(void) = default;
inline DisplayMode::DisplayMode(DisplayMode const &) = default;

1282 12 ~DisplayMode 0 4 1409 25 DisplayMode::~DisplayMode 0 0 0
32
...
1286 30 ~DisplayRegionCullCallbackData 0 4 1410 61 DisplayRegionCullCallbackData::~DisplayRegionCullCallbackData 0 0 0
68
...
1290 30 ~DisplayRegionDrawCallbackData 0 4 1411 61 DisplayRegionDrawCallbackData::~DisplayRegionDrawCallbackData 0 0 0
68
DisplayRegionDrawCallbackData::~DisplayRegionDrawCallbackData(void);

1291 23 DisplaySearchParameters 0 4 1412 48 DisplaySearchParameters::DisplaySearchParameters 0 2 623 624 10
/**
 *
 */
155
...
1292 24 ~DisplaySearchParameters 0 4 1412 49 DisplaySearchParameters::~DisplaySearchParameters 0 0 10
/**
 *
 */
56
...
1310 16 MouseAndKeyboard 0 4 1416 34 MouseAndKeyboard::MouseAndKeyboard 0 2 643 644 10
/**
 *
 */
184
...
1313 17 ~MouseAndKeyboard 0 4 1416 35 MouseAndKeyboard::~MouseAndKeyboard 0 0 0
42
...
1317 19 ~NativeWindowHandle 0 4 1418 39 NativeWindowHandle::~NativeWindowHandle 0 0 0
46
 ...
 *
 */ 0 
14 0 0 7 26 1328 661 0 0 1 6 param0 0 1427  
 ...
 * Returns the RenderBuffer::Type that corresponds to a RenderTexturePlane.
 */ 1 5 plane 1 1325  
89 0 0 7 122 1350 0 0 10 /**
 *
 */ 1 4 copy 1 1437  
90 0 0 7 122 1350 0 0 10 /**
 *
...
97 0 0 7 131 1341 0 0 0 1 6 param0 0 1442  
...
101 0 0 7 139 1447 754 0 0 2 4 args 1 1444  4 kwds 1 1444  
 ...
 * make_window_handle() method that returns an appropriate WindowHandle object
 * to wrap the particular OS-specific representation.
 */ 2 4 this 3 1447  13 parent_window 1 1350  
 ...
 * Returns the camera associated with this DisplayRegion, or an empty NodePath
 * if no camera is associated.
 */ 2 4 this 3 1460  14 current_thread 1 1467  
 ...
 * filename, or empty string if the screenshot failed.  The filename is
 * generated by make_screenshot_filename().
 */ 2 4 this 3 1393  6 prefix 1 1426  
235 0 0 6 674 1348 0 0 117 /**
 * Saves a screenshot of the region to the indicated filename.  Returns true
 * on success, false on failure.
 */ 3 4 this 3 1393  8 filename 1 1457  13 image_comment 1 1426  
 ...
 * Also see make_texture_buffer(), which is a higher-level interface for
 * preparing render-to-a-texture mode.
 */ 4 4 this 3 1353  3 tex 1 1372  4 mode 1 1356  8 bitplane 1 1334  
 ...
 * When you are done using the buffer, you should remove it with a call to
 * GraphicsEngine::remove_window().
 */ 7 4 this 3 1353  4 name 1 1426  6 x_size 1 1325  6 y_size 1 1325  3 tex 1 1372  6 to_ram 1 1348  3 fbp 1 1483  
 ...
 * geometry, particularly with TexGenAttrib::M_world_cube_map also in effect,
 * to apply a reflection of everything seen by the camera rig.
 */ 7 4 this 3 1353  4 name 1 1426  4 size 1 1325  10 camera_rig 1 1469  11 camera_mask 1 1484  6 to_ram 1 1348  3 fbp 1 1483  
 ...
 * filename, or empty string if the screenshot failed.  The filename is
 * generated by make_screenshot_filename().
 */ 2 4 this 3 1353  6 prefix 1 1426  
318 0 0 6 606 1348 0 0 304 /**
 * Saves a screenshot of the region to the indicated filename.  The image
 * comment is an optional user readable string that will be saved with the
 * header of the image (if the file format supports embedded data; for example
 * jpg allows comments).  Returns true on success, false on failure.
 */ 3 4 this 3 1353  8 filename 1 1457  13 image_comment 1 1426  
 ...
 * Texture::set_quality_level().
 */ 1 4 this 3 1489  
407 0 0 6 435 1444 0 0 0 1 4 this 3 1489  
 ...
 * this GraphicsEngine.  See GraphicsStateGuardian::set_loader().
 */ 1 4 this 3 1500  
434 0 0 7 503 1353 854 0 0 9 4 this 3 1375  4 pipe 1 1366  4 name 1 1426  4 sort 1 1325  7 fb_prop 1 1478  8 win_prop 1 1448  5 flags 1 1325  3 gsg 1 1358  4 host 1 1353  
 ...
 *
 */ 0 
453 0 0 7 475 1502 979 0 10 /**
 *
 */ 1 4 copy 1 1491  
454 0 0 7 475 1502 979 0 1237 /**
 * The threading model accepts a string representing the names of the two
 * threads that will process cull and draw for the given window, separated by
 * a slash.  The names are completely arbitrary and are used only to
 * differentiate threads.  The two names may be the same, meaning the same
...
472 0 0 7 754 1483 1186 0 0 1 6 param0 0 1478  
...
// record the data incoming on the device. 3 4 this 3 1510  6 button 1 1511  4 time 1 1513  
538 0 0 4 778 1425 0 0 189 /**
 * Records that the indicated button was depressed earlier, and we only just
 * detected the event after the fact.  This is mainly useful for tracking the
 * state of modifier keys.
 */ 3 4 this 3 1510  6 button 1 1511  4 time 1 1513  
539 0 0 4 779 1425 0 0 63 /**
 * Records that the indicated button has been released.
 */ 3 4 this 3 1510  6 button 1 1511  4 time 1 1513  
540 0 0 4 780 1425 0 0 67 /**
 * Records that the indicated keystroke has been generated.
 */ 3 4 this 3 1510  7 keycode 1 1325  4 time 1 1513  
 ...
 * To be called by a particular kind of GraphicsWindow to indicate that the
 * pointer is within the window, at the given pixel coordinates.
 */ 4 4 this 3 1510  1 x 1 1513  1 y 1 1513  4 time 1 1513  
 ...
 * To be called by a particular kind of GraphicsWindow to indicate that the
 * pointer data has changed.
 */ 3 4 this 3 1510  4 data 1 1517  4 time 1 1513  
...
552 0 0 7 799 1520 1208 0 0 1 6 param0 0 1518  
...
613 0 0 7 903 1542 1282 0 0 1 6 param0 0 1429  
 ...
 *
 */ 0 
624 0 0 7 916 1551 1292 0 0 1 6 param0 0 1552  
 ...
 * If the type is not already defined, this will implicitly load the named
 * module, or if module_name is empty, it will call load_aux_modules().
 */ 3 4 this 3 1557  9 type_name 1 1426  11 module_name 1 1426  
...
644 0 0 7 942 1558 1313 0 0 1 6 param0 0 1559  
